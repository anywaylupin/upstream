...
import { BookMarkedIcon, GaugeIcon, LayersIcon, type LucideIcon, NewspaperIcon } from 'lucide-react';
...
export function NavTabs({ stackCount, digestCount }: { stackCount: number; digestCount: number }) {
  ...
  return (
    <nav className="min-w-0">
      {/* Scrolls when the header is tight, without showing a scrollbar. */}
